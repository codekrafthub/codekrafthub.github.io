    ...
    <section id="caet-contact" className={styles.section}>
      <div className={styles.inner}>
        ...
        <div className={styles.labelRow}>
          ...
          <span className={styles.label}>Request Counselling</span>
        </div>

        <h2 className={styles.heading}>Speak With an Advisor.</h2>
        <p className={styles.sub}>
          Reach out to inquire about upcoming training batches, internship positions, or live
          collaborative bootcamps. No hard sell — just honest guidance.
        </p>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.infoCard}>
            ...
            <div className={styles.infoItem}>
              <span className={styles.infoIcon}><Phone size={20} strokeWidth={1.5} /></span>
              <div>
            ...
            <div className={styles.infoItem}>
              <span className={styles.infoIcon}><Briefcase size={20} strokeWidth={1.5} /></span>
              <div>
            ...
            <div className={styles.infoItem}>
              <span className={styles.infoIcon}><Camera size={20} strokeWidth={1.5} /></span>
              <div>
          ...
          <div className={styles.calendlyCard}>
            {!calendlyLoaded ? (
              <div className={styles.calendlyPlaceholder}>
                <div className={styles.calTag}>Free 30-Min Call</div>
                <div className={styles.calIcon}><Calendar size={28} strokeWidth={1.5} /></div>
                <p className={styles.calHeading}>Book a Free Counselling Call</p>
                <p className={styles.calSub}>
                  Discuss training batches, project guidance, or career roadmap queries with our
                  advisors.
                </p>
